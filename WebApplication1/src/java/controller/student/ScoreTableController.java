 ...
 * @author USER
 */
public class ScoreTableController extends BaseRequiredAuthenticationController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("subid") != null) {
            subjectId = Integer.parseInt(request.getParameter("subid"));
        }

        Score score = new ScoreDBContext().ScoreStudent(studentId, subjectId);
        ArrayList<Subject> subject = new SubjectDBContext().SubjectStudent();//ham nay loi
